...
if __name__ == "__main__":
    out = "../../data/nnUNet_raw_data/Task233_SplPanLiTSKiTS"
    ...
    unlabelled_label = "/dfsdata2/zhangyao_data/DB/Abdomen1K/Semi/unlabelled_labelsTr/"
