...
if __name__ == "__main__":
    base_image = "/dfsdata2/zhangyao_data/DB/Abdomen1K/Task100_FourAbdOrgans/imagesTs"
    base_label = "/dfsdata2/zhangyao_data/DB/Abdomen1K/Task100_FourAbdOrgans/labelsTs"
    out = "../data/nnUNet_raw_data/Task441_ContinualLiver"
    cases = np.sort(os.listdir(base_label))
    cases = [x for x in cases if x.split("_")[0] == "pancreas" and int(x.split(".")[0].split("_")[1]) <= 421]
