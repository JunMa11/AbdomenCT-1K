...
class nnUNetTrainerV2Finetune(nnUNetTrainer):
    """
    Info for Fabian: same as internal nnUNetTrainerV2Finetune_2
    """
    ...
    def do_split(self):
        ...
        if self.fold == 'all' or self.fold < 5:
            ...
            keys = [i for i in keys if 'spleen' in i]
    ...
    def on_epoch_end(self):
        ...
        # it can rarely happen that the momentum of nnUNetTrainerV2Finetune is too high for some dataset. If at epoch 100 the
