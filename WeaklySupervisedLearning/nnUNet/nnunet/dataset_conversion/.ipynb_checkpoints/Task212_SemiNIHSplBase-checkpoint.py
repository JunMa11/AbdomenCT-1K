...
if __name__ == "__main__":
    ...
    base_label = "../data/RESULTS_FOLDER/nnUNet/3d_fullres/Task200_SpleenOrgan/nnUNetTrainerV2__nnUNetPlansv2.1/all/predictions_NIH/"
    out = "../data/nnUNet_raw_data/Task212_SemiNIHSplBase"
