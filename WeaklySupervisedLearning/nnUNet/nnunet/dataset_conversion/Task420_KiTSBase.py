...
if __name__ == "__main__":
    ...
    out = "../data/nnUNet_raw_data/Task420_KiTSBase"
    cases = np.sort(os.listdir(base_label))
    cases = [x for x in cases if x.split("_")[0] == "case"]
