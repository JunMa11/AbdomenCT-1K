...
if __name__ == "__main__":
    ...
    out = "../data/nnUNet_raw_data/Task500_NIHSplKiTSOrgan"
    cases = np.sort(os.listdir(base_label))
    cases = [x for x in cases if (x.split("_")[0] == "pancreas" and int(x.split(".")[0].split("_")[1]) > 421) or x.split("_")[0] == "spleen" or x.split("_")[0] == "case"]
    ...
    json_dict = {}
    json_dict['name'] = "NIHSplKiTSOrgan"
